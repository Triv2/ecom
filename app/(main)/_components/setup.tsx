...
const Setup = () => {
  return (
    <section className="p-3">
      <h3 className="text-3xl text-center font-bold pb-5"> Setup</h3>
      ...
      <div className="flex justify-center  flex-col md:flex-row gap-10">
        <article className="bg-slate-400/10 rounded-md h-auto w-auto p-2 flex items-center justify-evenly flex-col border border-sky-800/30 shadow-md min-w-[30%]">
          <div className="flex md:flex-row flex-col items-center gap-3 p-2">
            <Image
            ...
            <div className="flex flex-col justify-evenly">
              <h4 className="font-bold text-2xl">Step One</h4>
        ...
        <article className="bg-slate-400/10 rounded-md h-auto w-auto p-2 flex items-center justify-evenly flex-col border border-sky-800/30 shadow-md min-w-[30%]">
          <div className="flex md:flex-row flex-col items-center gap-3 p-2">
            ...
            />
            <div className="flex flex-col justify-evenly">
              <h4 className="font-bold text-2xl">Step Two</h4>
        ...
        <article className="bg-slate-400/10 rounded-md h-auto w-auto p-2 flex items-center justify-evenly flex-col border border-sky-800/30 shadow-md min-w-[30%]">
          <div className="flex md:flex-row flex-col items-center gap-3 p-2">
            ...
            />
            <div className="flex flex-col justify-evenly">
              <h4 className="font-bold text-2xl">Step Three</h4>
