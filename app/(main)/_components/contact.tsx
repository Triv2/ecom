...
const Contact = () => {
  return (
    <section
      className="flex md:flex-row flex-col items-center gap-5 justify-center rounded-md shadow-md 
border border-sky-800/30 bg-gradient-to-br from-sky-100/40 to-neutral-100/30  py-10 md:py-20 px-2 md:px-20"
    >
      <article className="flex flex-col gap-5 md:w-[35%] border-b md:border-b-0 md:border-r space-y-8  border-slate-800/50">
        <h3
          className={cn(
            "text-3xl font-bold text-slate-800 px-1",
            font.className
          )}
        >
        ...
        <p className="text-muted-foreground px-1">
          Feel free to leave us an email at anytime or contact us through the
          webportal.
        </p>
        <div>
          <p className="font-semibold text-slate-700 px-1">
