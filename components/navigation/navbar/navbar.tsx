                      ...
                      {({ open }) => (
                        <>
                          ...
                          <Transition
                            ...
                            leaveTo="opacity-0"
                          >
                            <Popover.Panel className="absolute inset-x-0 top-full text-sm text-gray-500 z-50 shadow-xl">
                                  ...
                                  <div className="grid grid-cols-2 gap-x-8 gap-y-10 py-8">
                                    <div className="col-start-2 grid grid-cols-2 gap-x-8">
                                      ...
                                      {category.featured.map((item) => (
                                        ...
                                        >
                                          <div className="aspect-h-1 aspect-w-1 overflow-hidden rounded-lg bg-gray-100 border shadow-xl group-hover:opacity-75">
                                            <Image
                                              width={150}
                                              height={150}
                                              src="/landing/work1.webp"
